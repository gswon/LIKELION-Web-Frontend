      ...
      <div className="bg-gradient-to-r from-nyu-purple to-purple-800 text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold">캘린더 관리</h1>
              <p className="text-purple-200 mt-1">운영진 전용 - 일정 추가, 수정, 삭제</p>
            </div>
            <div className="flex gap-3">
              <button
                onClick={handleAddEvent}
                className="px-6 py-3 bg-ll-orange hover:bg-orange-600 rounded-lg transition-all duration-200 font-semibold shadow-button hover:shadow-hover"
              >
                + 일정 추가
              </button>
              <button
